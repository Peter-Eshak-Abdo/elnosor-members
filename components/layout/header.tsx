...
export function Header({ onMenuToggle, showBackButton = false, title }: HeaderProps) {
  ...
  return (
    <header className="bg-white/10 dark:bg-black/10 backdrop-blur-sm rounded-lg shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-1px_rgba(0,0,0,0.06)] sticky top-0 z-40 border-b border-white/20 dark:border-black/20 w-3/4 mx-auto">
